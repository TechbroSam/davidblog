  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <header className="text-center mb-16">
        ...
        <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">Welcome to my space, where I share my thoughts and experiences in the form of motivational quotes.</p>
      </header>
          ...
          <section id="latest-post" className="mb-16">
            ...
            <Link href={`/posts/${latestPost.id}`} className="group grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <h3 className="text-3xl font-bold group-hover:text-orange-700 group-hover:dark:text-orange-400 transition-colors">
                  {latestPost.title}
                </h3>
                <p className="line-clamp-4 mt-4 text-gray-600 dark:text-gray-300">
                  {latestPost.content}
                </p>
                <span className="text-orange-700 dark:text-orange-400 font-semibold hover:underline mt-4 inline-block">
                  Read more &rarr;
                </span>
              </div>
            </Link>
